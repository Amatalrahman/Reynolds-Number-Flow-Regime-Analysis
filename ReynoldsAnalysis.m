...
%% Part 1: Reynolds Number Calculator & Regime Classification (Modified Display Logic)
...
function createInteractiveCalculator()
    % Create a simple interactive figure for Reynolds number calculation
    fig = figure('Name', 'Interactive Reynolds Number Calculator', ...
        'Position', [200, 200, 400, 500], 'NumberTitle', 'off');
    
    % Create UI controls
    uicontrol('Style', 'text', 'Position', [20, 450, 200, 20], ...
        'String', 'Density (kg/m³):', 'HorizontalAlignment', 'left');
    density_edit = uicontrol('Style', 'edit', 'Position', [200, 450, 100, 20], ...
        'String', '1000');
    
    uicontrol('Style', 'text', 'Position', [20, 420, 200, 20], ...
        'String', 'Viscosity (Pa·s):', 'HorizontalAlignment', 'left');
    viscosity_edit = uicontrol('Style', 'edit', 'Position', [200, 420, 100, 20], ...
        'String', '0.001');
    
    uicontrol('Style', 'text', 'Position', [20, 390, 200, 20], ...
        'String', 'Velocity (m/s):', 'HorizontalAlignment', 'left');
    velocity_edit = uicontrol('Style', 'edit', 'Position', [200, 390, 100, 20], ...
        'String', '1.0');
    
    uicontrol('Style', 'text', 'Position', [20, 360, 200, 20], ...
        'String', 'Characteristic Length (m):', 'HorizontalAlignment', 'left');
    length_edit = uicontrol('Style', 'edit', 'Position', [200, 360, 100, 20], ...
        'String', '0.01');
    
    % Calculate button
    uicontrol('Style', 'pushbutton', 'Position', [150, 300, 100, 30], ...
        'String', 'Calculate', 'Callback', @calculateCallback);
    
    % Results display
    result_text = uicontrol('Style', 'text', 'Position', [50, 200, 300, 80], ...
        'String', 'Enter values and click Calculate', 'HorizontalAlignment', 'center', ...
        'FontSize', 12, 'BackgroundColor', [0.9, 0.9, 0.9]);
    
    function calculateCallback(~, ~)
        try
            % Get values from UI
            rho = str2double(density_edit.String);
            mu = str2double(viscosity_edit.String);
            V = str2double(velocity_edit.String);
            L = str2double(length_edit.String);
            ...
            % Display results
            result_str = sprintf('Reynolds Number: Re = %.2f\nFlow Regime: %s', Re, regime);
            result_text.String = result_str;
            result_text.BackgroundColor = color;
            result_text.ForegroundColor = [1, 1, 1];
            
        catch
            result_text.String = 'Error: Check input values';
            result_text.BackgroundColor = [0.8, 0, 0];
        end
    end
end
